...
cfg1 = CFG()
cfg1.add_prod('S','P. P')
cfg1.add_prod('S', 'GN GV | ccAvec GN GV | CCT GN GV|' 'GN GN GN ')
cfg1.add_prod('CCAvecADV', 'ne sachant pas conduire | ayant consience de la fragilité de la' )
cfg1.add_prod('P', 'GN GV | GN GV CCM| CCT GN GV| GN GV PropSub')
cfg1.add_prod('CCM', 'doucement | comme s il n y avait pas de lendemain')
